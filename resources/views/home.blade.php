<x-layout>
    ...
    <section>
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6 mb-10">
    ...
    <footer class="bg-blue-100 dark:bg-gray-800 antialiased mt-20">
